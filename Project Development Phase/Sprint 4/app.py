...
try:
    ...
    conn_str='database=bludb;hostname=ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=31321;protocol=tcpip;uid=vmk08423;pwd=3KfJl6HGDtPdbIWy;security=SSL'
...
def login():
    ...
    if request.method == 'POST' :
        ...
        # sendmail("hello user","user123@gmail.com")
...
def jls_extract_def():
    return 'viewanalysis.html'

@app.route("/display")
def display():

    print(sesssion["username"],session['id'])
    ...
    while dictionary != False:
        ...
        temp.append(dictionary["EXPENSE NAME"])
...
ibm_db.fetch_assoc(res) return render_template(jls_extract_def())
...
lif x[6] == "EMI":
 ...
 return render_template("today.html", texpense = texpense, expense = expense,  total = total ,
                           t_food = t_food,t_entertainment =  t_entertainment, t_business = t_business,  t_rent =  t_rent,
                           t_EMI =  t_EMI,  t_other =  t_other )
